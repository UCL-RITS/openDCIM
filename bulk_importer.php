...
//	$header=__("");
  ...
  if ( isset( $_FILES['inputfile'] )) {
    ...
    if ( $valid ) {
      ...
      if ( $valid ) {
        ...
        if ( ! $valid ) {
          ...
          foreach( array( "DataCenterID", "Cabinet", "Position", "Label", "Height", "Manufacturer", "Model", "Hostname", "SerialNo", "AssetTag", "ESX", "BackSide", "HalfDepth", "Reservation", "InstallDate", "WarrantyExpire", "Owner", "PrimaryContact", "CustomTags" ) as $mapVar ) {
    ...
    $content = "";
    $fields = array( "DataCenterID", "Cabinet", "Position", "Label", "Height", "Manufacturer", "Model", "Hostname", "SerialNo", "AssetTag", "ESX", "BackSide", "HalfDepth", "Reservation", "Owner", "InstallDate", "WarrantyExpire", "PrimaryContact", "CustomTags" );
	...
	if ( $row["WarrantyExpire"] != "" ) {
        $dev->WarrantyExpire = date( "Y-m-d", strtotime( $row["WarrantyExpire"]));
      } else {
