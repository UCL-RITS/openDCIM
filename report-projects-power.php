	...
	if(isset($_REQUEST['projectid'])){
		...
		if($project!=''){
			...
			$sql="SELECT a.ProjectID, a.ProjectName, b.DeviceID, c.Location, b.Position, 
				...
				b.TemplateID, b.Owner, b.WarrantyExpire, b.NominalWatts, e.Name as DataCenterName, c.CabinetID, e.DataCenterID 
...
modfied by cceawva to add warranty information
...
$warrantydate=date('d-m-Y',strtotime($row["WarrantyExpire"]));
			...
			if($row["DeviceType"]=="Chassis"){
				...
				foreach($childList as $child){
					...
					$cNominalWatts="<a href=\"devices.php?DeviceID=$child->DeviceID\" target=\"device\">$child->NominalWatts</a></td>";
